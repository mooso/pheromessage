...
pub fn uniform_local_gossip_set<T, M, I>(
    num_nodes: usize,
    fanout: usize,
) -> Vec<LocalUniformGossipSetNode<T, M, I>>
where
    M: Clone + Message<I = I>,
...
pub fn preferential_local_gossip_set<T, M, I>(
    num_nodes: usize,
    num_primaries: usize,
    fanout: usize,
) -> Vec<LocalPreferentialGossipSetNode<T, M, I>>
where
    M: Clone + Message<I = I>,
    GossipSet<T>: SharedData<M>,
    I: Hash + Eq,
